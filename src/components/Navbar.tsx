    ...
    >
      ...
      <div className="flex h-[60px] items-center px-4 border-b border-[rgba(55,50,47,0.08)] dark:border-[#44403C]">
        ...
        >
          ...
          {sidebarOpen && (
            <span className="font-sans text-h3 font-bold tracking-tight text-[#37322F] dark:text-[#F5F5F4]">
              Askio
            </span>
          )}
        </Link>
      ...
      <div className="mt-auto border-t border-[rgba(55,50,47,0.08)] dark:border-[#44403C] p-4 space-y-1">
        ...
        {/* User Profile */}
        <div className={`flex items-center gap-3 pt-2 mt-2 border-t border-[rgba(55,50,47,0.08)] dark:border-[#44403C] ${!sidebarOpen && "justify-center"}`}>

  ...
  return (
    <div className="p-6 lg:p-10 max-w-[1200px] mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-h1 font-serif text-[#37322F] dark:text-[#F5F5F4]">Integrations</h1>
          <p className="text-body text-[#605A57] dark:text-[#A8A29E]">Connect Askio with your favorite tools.</p>
        </div>
      </div>
      ...
      <div className="rounded-xl border border-[rgba(55,50,47,0.12)] dark:border-[#44403C] bg-white dark:bg-[#292524] p-12 text-center">
        ...
        <p className="text-body text-[#605A57] dark:text-[#A8A29E]">
          We are working on adding powerful integrations to Askio. Stay tuned!
        </p>
      </div>
    </div>
  );

...
export default function LandingNav() {
  ...
  return (
    <header className="relative z-50 flex justify-center pt-3 pb-4">
      ...
      <nav
        className={`relative z-30 w-full max-w-[700px] h-11 px-4 pr-2 backdrop-blur-sm rounded-full flex justify-between items-center border transition-all duration-300 ${
          scrolled
